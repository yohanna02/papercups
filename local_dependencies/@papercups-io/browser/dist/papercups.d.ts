...
export declare class Papercups {
    ...
    identify: (externalId: string, metadata?: {}) => Promise<any>;
    createOrUpdateCustomer: (existingCustomerId?: string | null | undefined, metadata?: Partial<CustomerMetadata>) => Promise<string>;
    fetchWidgetSettings: () => Promise<WidgetSettings>;
    updateWidgetSettingsMetadata: (metadata: any) => Promise<void | WidgetSettings>;
    findCustomerByExternalId: (externalId: string, filters?: {}) => Promise<string | null>;
    findCustomerByMetadata: (metadata: CustomerMetadata) => Promise<string | null>;
    ...
    notify: (type: 'slack' | 'email', message: string, options?: {}) => void;
}
